...
<?php 
  ...
  //se pasa a la carga de los lotes del articulo seleccionado 
    ...
    R22_Articulo_Lote($_GET['SEDE'],$_GET['Id'],$_GET['Nombre']);
...
/**********************************************************************************/
  ...
  */
  ...
  /**********************************************************************************/
  /*
    TITULO: R23Q_Lista_Lotes
    FUNCION: Armar una lista de articulos con descripcion e id
    RETORNO: Lista de articulos con descripcion e id
    DESAROLLADO POR: SERGIO COVA
  */
  function R23Q_Lista_Lotes($IdArticulo) {
    $sql = "
    SELECT
    InvLote.Id,
    InvLote.Numero,
  ...
  /*
    ...
    DESAROLLADO POR: SERGIO COVA
  */
  function R22_Articulo_Lote($SedeConnection,$IdArticulo,$Descripcion){
    
    $conn = FG_Conectar_Smartpharma($SedeConnection);
    $sql1 = R23Q_Lista_Lotes($IdArticulo);
