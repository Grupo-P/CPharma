    ...
    <div class="card-deck">
        <div class="card border-danger mb-3" style="width: 14rem;">
            ...
            <div class="card-footer bg-transparent border-danger text-right">
                <a href="/efectivo?sede=FTN" class="btn btn-outline-danger btn-sm">Visualizar</a>
            </div>
        </div>
        ...
        <div class="card border-success mb-3" style="width: 14rem;">
            ...
            <div class="card-footer bg-transparent border-success text-right">
                <a href="/efectivo?sede=FAU" class="btn btn-outline-success btn-sm">Visualizar</a>
            </div>
        </div>
        ...
        <div class="card border-info mb-3" style="width: 14rem;">
            ...
            <div class="card-footer bg-transparent border-info text-right">
                <a href="/efectivo?sede=FLL" class="btn btn-outline-info btn-sm">Visualizar</a>
            </div>
        </div>
    </div>
