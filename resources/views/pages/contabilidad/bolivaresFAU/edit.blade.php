...
@section('title', 'Modificar pago en efectivo bolívares FAU')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares FAU
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresFAU.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
