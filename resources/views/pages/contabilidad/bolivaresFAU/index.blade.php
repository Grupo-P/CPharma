...
@section('title', 'Registro de pagos en efectivo bolívares FAU')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Registro de pagos en efectivo bolívares FAU
  </h1>
    ...
    <tr>
      ...
      @if(auth()->user()->departamento == 'TESORERIA' || auth()->user()->departamento == 'TECNOLOGIA')
        ...
        <td style="width:20%;" align="center">
          <a href="/bolivaresFAU/create?tipo=proveedores" role="button" class="btn btn-outline-info btn-sm"
          style="display: inline; text-align: left;">
          <i class="fa fa-plus"></i>
        ...
        <td style="width:140px;">
            @if(!$pago->ingresos)
                @if (!($pago->egresos && strpos($pago->concepto, 'DIFERIDO')))
                    <a target="_blank" href="/bolivaresFAU/soporte/{{$pago->id}}" role="button" class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="top" title="Ver soporte">
