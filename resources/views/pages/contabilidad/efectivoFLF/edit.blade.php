...
@section('title', 'Modificar pago en efectivo dólares FLF')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares FLF
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoFLF.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
