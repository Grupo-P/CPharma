...
@section('title', 'Modificar pago en efectivo dólares FAU')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares FAU
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoFAU.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
