...
@section('title', 'Modificar pago en efectivo dólares FTN')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares FTN
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoFTN.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
