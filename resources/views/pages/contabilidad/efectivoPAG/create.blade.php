...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    @if($request->get('tipo') == 'movimiento')
      Agregar movimiento dólares PAG
    @endif

    @if($request->get('tipo') == 'proveedores')
      Agregar pago a proveedores dólares PAG
    @endif
  </h1>
  <hr class="row align-items-start col-12">

  <a href="/efectivoPAG" class="btn btn-outline-info btn-sm">
  ...
  {!! Form::open(['route' => 'efectivoPAG.store', 'method' => 'POST', 'id' => 'crear_movimientos', 'class' => 'form-group']) !!}
    @if($request->get('tipo') == 'movimiento')
      <fieldset>
