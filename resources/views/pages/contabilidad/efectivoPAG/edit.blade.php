...
@section('title', 'Modificar pago en efectivo dólares PAG')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares PAG
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoPAG.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
