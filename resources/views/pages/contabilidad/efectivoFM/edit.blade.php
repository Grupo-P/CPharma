...
@section('title', 'Modificar pago en efectivo dólares FM')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares FM
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoFM.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
