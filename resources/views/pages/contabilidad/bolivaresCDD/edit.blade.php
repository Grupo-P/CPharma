...
@section('title', 'Modificar pago en efectivo bolívares CDD')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares CDD
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresCDD.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
