...
@section('title', 'Modificar pago en efectivo bolívares FEC')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares FEC
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresFEC.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
