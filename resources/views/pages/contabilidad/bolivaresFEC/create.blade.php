...
@section('title', 'Registro de pagos en efectivo bolívares FEC')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    @if($request->get('tipo') == 'movimiento')
      Agregar movimiento bolívares FEC
    @endif

    @if($request->get('tipo') == 'proveedores')
      Agregar pago a proveedores bolívares FEC
    @endif
  </h1>
  <hr class="row align-items-start col-12">

  <a href="/bolivaresFEC" class="btn btn-outline-info btn-sm">
  ...
  {!! Form::open(['route' => 'bolivaresFEC.store', 'method' => 'POST', 'id' => 'crear_movimientos', 'class' => 'form-group']) !!}
    @if($request->get('tipo') == 'movimiento')
      <fieldset>
