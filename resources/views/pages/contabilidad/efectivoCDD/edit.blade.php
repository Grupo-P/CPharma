...
@section('title', 'Modificar pago en efectivo dólares CDD')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares CDD
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoCDD.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
