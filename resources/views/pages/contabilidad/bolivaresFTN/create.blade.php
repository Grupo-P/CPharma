...
@section('title', 'Registro de pagos en efectivo bolívares FTN')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    @if($request->get('tipo') == 'movimiento')
      Agregar movimiento bolívares FTN
    @endif

    @if($request->get('tipo') == 'proveedores')
      Agregar pago a proveedores bolívares FTN
    @endif
  </h1>
  ...
  {!! Form::open(['route' => 'bolivaresFTN.store', 'method' => 'POST', 'id' => 'crear_movimientos', 'class' => 'form-group']) !!}
    @if($request->get('tipo') == 'movimiento')
      <fieldset>
