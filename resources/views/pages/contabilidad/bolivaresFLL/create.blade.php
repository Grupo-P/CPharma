...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    @if($request->get('tipo') == 'movimiento')
      Agregar movimiento bolívares FLL
    @endif

    @if($request->get('tipo') == 'proveedores')
      Agregar pago a proveedores bolívares FLL
    @endif
  </h1>
  <hr class="row align-items-start col-12">

  <a href="/bolivaresFLL" class="btn btn-outline-info btn-sm">
  ...
  {!! Form::open(['route' => 'bolivaresFLL.store', 'method' => 'POST', 'id' => 'crear_movimientos', 'class' => 'form-group']) !!}
    @if($request->get('tipo') == 'movimiento')
      <fieldset>
            ...
            <tbody>
                <tr>
                    <td colspan="2">
                        ...
                        <input class="form-control" name="monto" type="number" step="0.01" min="0.01" required value="{{ ($prepagado != '') ? $prepagado->monto : '' }}">
                    </td>
