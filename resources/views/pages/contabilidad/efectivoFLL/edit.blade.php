...
@section('title', 'Modificar pago en efectivo dólares FLL')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares FLL
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoFLL.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
