...
@section('title', 'Modificar pago en efectivo bolívares FM')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares FM
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresFM.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
