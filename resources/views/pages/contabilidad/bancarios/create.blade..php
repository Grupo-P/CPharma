...
<form action="/bancarios" method="POST" x-data="{ saldo: null }">
    @csrf
    <fieldset>
        <table class="table table-borderless table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="saldo" value="" type="text"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="saldo_iva" readonly type="text"/>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="pago_iva" type="text">
                    </th>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="retencion_deuda_1">
                            Retención deuda (%)
                        </label>
                    </th>
                    <th scope="row">
                        <input class="form-control" name="retencion_deuda_1" type="text">
                    </th>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="retencion_deuda_2">
                            Retención deuda (%)
                        </label>
                    </th>
                    <th scope="row">
                        <input class="form-control" name="retencion_deuda_2" type="text">
                    </th>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="retencion_iva">
                            Retención IVA (%)
                        </label>
                    </th>
                    <th scope="row">
                        <input class="form-control" name="retencion_iva" type="text">
                    </th>
                </tr>
