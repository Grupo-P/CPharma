        ...
        <table class="table table-borderless table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input autofocus class="form-control" id="proveedores" type="text" readonly value="{{ $pago->proveedor->nombre_proveedor . ' | ' . $pago->proveedor->rif_ci }}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="moneda" readonly type="text" value="{{ $pago->proveedor->moneda }}">
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="saldo" readonly type="text" value="{{ number_format($pago->proveedor->saldo, 2, ',', '.') }}">
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <input class="form-control" name="tasa_proveedor" readonly type="text" value="{{ $pago->proveedor->tasa }}">
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" lang="en" name="monto_proveedor" required step="0.01" value="{{ $pago->monto }}" type="number">
                    </td>
                </tr>
