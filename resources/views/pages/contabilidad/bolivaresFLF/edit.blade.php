...
@section('title', 'Modificar pago en efectivo bolívares FLF')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares FLF
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresFLF.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
