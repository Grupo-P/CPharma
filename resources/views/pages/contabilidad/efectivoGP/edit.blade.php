...
@section('title', 'Modificar pago en efectivo dólares GP')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo dólares GP
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['efectivoGP.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
