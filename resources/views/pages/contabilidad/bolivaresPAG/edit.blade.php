...
@section('title', 'Modificar pago en efectivo bolívares PAG')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares PAG
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresPAG.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
