...
@section('title', 'Registro de pagos en efectivo bolívares PAG')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    @if($request->get('tipo') == 'movimiento')
      Agregar movimiento bolívares PAG
    @endif

    @if($request->get('tipo') == 'proveedores')
      Agregar pago a proveedores bolívares PAG
    @endif
  </h1>
  <hr class="row align-items-start col-12">

  <a href="/bolivaresPAG" class="btn btn-outline-info btn-sm">
  ...
  {!! Form::open(['route' => 'bolivaresPAG.store', 'method' => 'POST', 'id' => 'crear_movimientos', 'class' => 'form-group']) !!}
    @if($request->get('tipo') == 'movimiento')
      <fieldset>
