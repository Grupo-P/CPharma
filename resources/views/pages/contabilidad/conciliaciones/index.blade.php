          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h4 class="h6">Pago conciciliado exitosamente</h4>
              </div>
    ...
    <table class="table table-striped table-borderless col-12 sortable" id="myTable">
        ...
        @foreach($pagos as $pago)
            <tr>
              ...
              <td>{{isset($pago['monto']) ? $pago['monto'] : $pago['egresos'] }}</td>
              <td>{{ ($pago['tipo'] == 'Banco') ? $pago['banco']['alias_cuenta'] : '' }}</td>
              ...
              <td style="width:180px;">
                ...
                @if(Auth::user()->departamento == 'TECNOLOGIA' || Auth::user()->departamento == 'GERENCIA' || Auth::user()->departamento == 'ADMINISTRACION')
                    <a href="/bancarios/{{$pago['id']}}/edit" role="button" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="top" title="Modificar">
