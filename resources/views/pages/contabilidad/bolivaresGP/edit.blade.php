...
@section('title', 'Modificar pago en efectivo bolívares GP')
...
@section('content')
  ...
  <h1 class="h5 text-info">
    ...
    Modificar pago en efectivo bolívares GP
  </h1>
  ...
  {!! Form::model($pago, ['route' => ['bolivaresGP.update', $pago], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
