		    ...
		    <!-- Inicio Validacion de ROLES -->
		      <td style="width:140px;">
				...
				?>
					...
					?>
						<a href="/departamento/{{$departamento->id}}" departamentoe="button" class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="top" title="Detalle">
			      			<i class="far fa-eye"></i>			      		
			      		</a>

			      		<a href="/departamento/{{$departamento->id}}/edit" departamentoe="button" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="top" title="Modificar">
				...
				<?php
				} else if(Auth::user()->departamentoe == 'USUARIO'){
				?>
