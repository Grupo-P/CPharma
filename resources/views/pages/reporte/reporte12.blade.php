  ...
  function R12Q_seccion1($FInicial,$FFinal,$IdArticulo) {
    $sql = "
      ...
      AND (
        ...
        OR (InvMovimiento.InvCausaId=14) OR (InvMovimiento.InvCausaId=15) OR (InvMovimiento.InvCausaId=(select InvCausa.Id from InvCausa where InvCausa.Descripcion = 'Traslado'))
      )
