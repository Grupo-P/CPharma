  ...
  * {
  ...
  <script>
      function mostrar_ocultar(that, elemento) {
        ...
        campos = ['codigo', 'codigo_barra', 'descripcion', 'precio', 'dias_falla', 'existencia', 'cantidad_recibida', 'fecha_llegada', 'tipo', 'dolarizado', 'gravado', 'clasificacion', 'ultima_venta', 'ultimo_proveedor'];
  ...
  function R26_Ultimas_Entradas($SedeConnection,$FInicial,$FFinal){
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="mostrar_ocultar(this, \'fecha_llegada\')" name="fecha_llegada" checked>
                    Fecha llegada
                </div>
    ...
    <table class="table table-striped table-bordered col-12 sortable" id="myTable">
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col" class="cantidad_recibida CP-sticky">Cantidad recibida</td>
            <th scope="col" class="fecha_llegada CP-sticky">Fecha Llegada</th>
    ...
    while($row = sqlsrv_fetch_array($result,SQLSRV_FETCH_ASSOC)) {
      ...
      if($RowCPharma['cuenta'] == 0){
        ...
        echo '<td class="dias_falla" align="center">'.$diasFalla.'</td>';
        ...
        echo '<td class="fecha_llegada" align="center">'.$ultimaCompra->format('d-m-Y').'</td>';
