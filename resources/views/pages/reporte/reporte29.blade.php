  ...
  //CASO 1: AL CARGAR EL REPORTE DESDE EL MENU
    ...
    <form autocomplete="off" action="" target="_blank">
      <div class="autocomplete" style="width:90%;">
        <input class="inputMarca" id="myInput" type="text" name="Nombre" placeholder="Ingrese el nombre del proveedor " required>
...
<?php
 ...
 /*FIN PARA CALCULOS CON DIAS EN CERO*/
    ...
    $PrecioCompraBrutoAlmacen2,$PrecioCompraBruto,$IsIVA,$CondicionExistencia);
      ...
      echo '<td align="center" class="producto_unico">'.$Unico.'</td>';
