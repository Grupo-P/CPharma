        ...
        <table style="width:100%;">
          ...
          <tr>
            <td colspan="6">
              ...
              <input id="myInput" type="text" name="Descrip" class="inputDescripcion" placeholder="Ingrese el nombre del articulo...">
...
<?php
 ...
 /*FIN PARA CALCULOS CON DIAS EN CERO*/
    ...
    if($Flag=='Descrip') {
      ...
      echo'
          <button type="submit" class="btn btn-outline-success btn-sm"  style="width:100%;">Agregar</button>
        </form>
        ';
