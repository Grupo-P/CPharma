...
@section('title', 'Modificar práctica')
...
@section('content')
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="h6">La práctica no fue almacenada</h4>
          </div>
  ...
  {!! Form::model($practicas, ['route' => ['practicas.update', $practicas], 'method' => 'PUT', 'class' => 'form-group']) !!}
    <fieldset>
