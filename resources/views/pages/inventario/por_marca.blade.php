...
<?php
  ...
  //CASO 2: CARGA AL HABER SELECCIONADO UN PROVEEDOR
    ...
    <form autocomplete="off" action="/inventario/create">
      <table style="width:100%;">
        <tr>
          ...
          <td>
          <input id="origen" name="origen" type="hidden" value="Marca">
          </td>
          <td align="right">
    ...
    <br>
    ';
    Iventario_Marca_C2($_GET['SEDE'],$_GET['Id'],$_GET['Nombre']);
    echo'</form>';
  ...
  //CASO 1: AL CARGAR EL REPORTE DESDE EL MENU
    ...
    <form autocomplete="off" action="">
      <div class="autocomplete" style="width:90%;">
        <input class="inputMarca" id="myInput" type="text" name="Nombre" placeholder="Ingrese el nombre de la marca " onkeyup="conteo()" required>
...
<?php
  /**********************************************************************************/
  /*
    TITULO: Iventario_Marca_C2
    FUNCION: Armar el reporte catalogo de proveedor
    RETORNO: No aplica
    DESAROLLADO POR: SERGIO COVA
  */
  function Iventario_Marca_C2($SedeConnection,$IdMarca,$NombreArticulo){
