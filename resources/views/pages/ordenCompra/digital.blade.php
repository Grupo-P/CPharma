	...
	<table>
		<thead>
		    <tr>
		    		...
		    		<th scope="row" colspan="13" class="aumento">Soporte de orden de compra</th>
		    </tr>
  	</thead>
	  	<tbody>
		    <tr>
	      	<td colspan="13" class="alinear-der">Codigo:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->codigo}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha De Orden:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->created_at}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Destino:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->sede_destino}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Proveedor:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->proveedor}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha Despacho:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->fecha_estimada_despacho}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Condicion Crediticia:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->condicion_crediticia}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Dias Credito:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->dias_credito}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Operador Orden:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->user}}</td>
		    </tr>
	  		<tr>
	      	<td colspan="13" class="alinear-der">Estatus:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->estado}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Observacion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->observacion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha De Aprobacion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->fecha_aprobacion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Operador De Aprobacion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->operador_aprobacion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha De Recepcion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->fecha_recepcion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Operador De Recepcion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->operador_recepcion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha De Ingreso:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->fecha_ingreso}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Operador De Ingreso:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->operador_ingreso}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Calificacion:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->calificacion}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Factura:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->numero_factura}}</td>
		    </tr>
		    <tr>
	      	<th colspan="13" class="alinear-der">Monto Real:</th>
	      	<th colspan="13" class="alinear-izq">{{number_format($OrdenCompra->montoTotalReal,2,"," ,"." )}} {{$OrdenCompra->moneda}}</th>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Fecha De Cierre:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->fecha_cierre}}</td>
		    </tr>
		    <tr>
	      	<td colspan="13" class="alinear-der">Operador De Cierre:</td>
	      	<td colspan="13" class="alinear-izq">{{$OrdenCompra->operador_cierre}}</td>
		    </tr>
			<thead>
		    <tr>
		    		<th scope="row">#</th>
