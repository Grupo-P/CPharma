...
@section('content')
	...
	<br/>
    <div class="col-12">                        
        <form action="{{route("clientesTransaccionales2")}}" method="POST">
            @csrf
            <div class="row">
                <div class="col-4">
	...
	<table class="table table-striped table-borderless col-12 sortable" id="myTable">
	  	<thead class="thead-dark">
		    <tr>
                ...
                <th scope="col" class="CP-sticky">Nombre del cliente</th>                
                ...
                <th scope="col" class="CP-sticky">Cantidad vueltos</th>
