...
@section('content_header')
    ...
    @php
        ...
        $favorito = Favoritos::validar_favorito('core.auditorias.index',auth()->user()->id);
        if($favorito){
    ...
    <h1 class="mt-2">
        <form action="{{route('core.favoritos.gestionar')}}" method="POST">
            ...
            <input type="hidden" name="nombre" value="Auditoría">
    ...
    <div class="card shadow">
        <div class="card-header">            
            ...
            <div style="display:inline-block;" class="float-right">
                ...
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="1"> Modelo</input>
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="2"> Evento</input>
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="3"> Desencadenador</input>
            ...
            <table id="resultadosTable" class="table table-striped">
                ...
                <tbody>
                    @foreach($auditorias as $auditoria)
                        <tr>
                            <td class="isSelectable">{{ $auditoria['id'] }}</td>
                            <td>{{ $auditoria['subject_type'] }}</td>
                            <td style="text-transform: capitalize;">{{ $auditoria['event'] }}</td>
                            <td>{{ $auditoria['causer_type'] }}</td>
                            <td>{{ $auditoria['updated_at'] }}</td>                                                    

                            <td class="text-center">
                                <div class="btn-group">                                    
                                    @can('core.auditorias.show')
                                        <a href="{{route('core.auditorias.show', $auditoria['id'])}}" type="button" class="btn btn-success mr-1 rounded" data-toggle="tooltip" data-placement="left" title="Ver"><i class="fas fa-eye"></i></a>
                                    @endcan                                    
                                </div>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="isSearchable">subject_type</th>
                        <th class="isSearchable">event</th>
                        <th class="isSearchable">causer_type</th>
                        <th class="isSearchable">updated_at</th>
                        <th class="isSpace"></th>
                    </tr>
                </tfoot>
            </table>
