...
@section('content_header')
    ...
    @php
        ...
        $favorito = Favoritos::validar_favorito('core.parametros.index',auth()->user()->id);
        if($favorito){
    ...
    <h1>
        <form action="{{route('core.favoritos.gestionar')}}" method="POST">
            ...
            <input type="hidden" name="nombre" value="Parámetros">
            <input type="hidden" name="ruta" value="core.parametros.index">
