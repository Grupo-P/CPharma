...
@section('content_header')
    ...
    @php
        ...
        $favorito = Favoritos::validar_favorito('core.usuarios.index',auth()->user()->id);
        if($favorito){
    ...
    <h1 class="mt-2">
        <form action="{{route('core.favoritos.gestionar')}}" method="POST">
            ...
            <input type="hidden" name="nombre" value="Usuarios">
            <input type="hidden" name="ruta" value="core.usuarios.index">
