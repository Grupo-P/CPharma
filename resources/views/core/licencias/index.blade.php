...
@section('content_header')
    ...
    @php
        ...
        $favorito = Favoritos::validar_favorito('core.licencias.index',auth()->user()->id);
        if($favorito){
    ...
    <h1 class="mt-2">
        <form action="{{route('core.favoritos.gestionar')}}" method="POST">
            ...
            <input type="hidden" name="ruta" value="core.licencias.index">
    ...
    <div class="card shadow">
        <div class="card-header">            
            ...
            <div style="display:inline-block;" class="float-right">
                ...
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="1"> Hash 1</input>
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="2"> Hash 2</input>
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="3"> Hash 3</input>
                <input class="toggle-vis" type="checkbox" checked="checked" data-column="4"> Hash 4</input>
            ...
            <table id="resultadosTable" class="table table-striped">
                ...
                <tbody>
                    @foreach($licencias as $licencia)
                        <tr>
                            <td class="isSelectable">{{ $licencia->id }}</td>
                            <td>{{ $licencia->hash1 }}</td>
                            <td>{{ $licencia->hash2 }}</td>
                            <td>{{ $licencia->hash3 }}</td>
                            <td>{{ $licencia->hash4 }}</td>                                                    

                            <td class="text-center">
                                <div class="btn-group">                                    
                                    @can('core.licencias.edit')
                                        <a href="{{route('core.licencias.edit', $licencia)}}" type="button" class="btn btn-info mr-1 rounded" data-toggle="tooltip" data-placement="left" title="Editar"><i class="fas fa-edit"></i></a>
                                    @endcan                                    
                                </div>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="isSearchable">hash1</th>
                        <th class="isSearchable">hash2</th>
                        <th class="isSearchable">hash3</th>
                        <th class="isSearchable">hash4</th>
                        <th class="isSpace"></th>
                    </tr>
                </tfoot>
            </table>
