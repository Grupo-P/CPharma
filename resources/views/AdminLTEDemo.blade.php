...
@section('content')    
    ...
    @php
        ...
        $btnDetails = '<button class="btn btn-sm btn-outline-success mx-1 shadow" title="Details">
                        <i class="fa fa-lg fa-fw fa-eye"></i>
                    </button>';
        $btnEdit = '<button class="btn btn-sm btn-outline-primary mx-1 shadow" title="Edit">
