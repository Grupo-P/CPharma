...
class CreateContPagosBolivaresFauTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cont_pagos_bolivares_fau', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cont_pagos_bolivares_fau');
    }
}
