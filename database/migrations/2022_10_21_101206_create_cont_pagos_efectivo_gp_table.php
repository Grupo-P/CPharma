...
class CreateContPagosEfectivoGpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cont_pagos_efectivo_gp', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cont_pagos_efectivo_gp');
    }
}
