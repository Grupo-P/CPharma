...
class CreateContPagosBolivaresFtnTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cont_pagos_bolivares_ftn', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cont_pagos_bolivares_ftn');
    }
}
