...
class CreateContPagosBolivaresGpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cont_pagos_bolivares_gp', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cont_pagos_bolivares_gp');
    }
}
