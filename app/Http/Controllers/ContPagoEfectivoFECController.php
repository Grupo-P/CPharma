...
use compras\ContPagoEfectivoFEC as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoEfectivoFECController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFEC.index', compact(
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFEC.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoFEC')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoFEC')->first();
            ...
            return redirect('/efectivoFEC')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.efectivoFEC.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.efectivoFEC.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosFEC')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFEC.diferidos', compact('diferidos'));
    }
}
