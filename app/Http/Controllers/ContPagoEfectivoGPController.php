...
use compras\ContPagoEfectivoGP as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoEfectivoGPController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $pagos = ContPagoEfectivo::fecha(request('fecha_desde'), request('fecha_hasta'))
            ->orderBy('created_at', 'desc')
            ->cantidad($cantidad);

        $sedes = Sede::get();

        return view('pages.contabilidad.efectivoGP.index', compact(
            'pagos', 'sedes', 'request', 'selected50', 'selected100', 'selected200', 'selected500', 'selected1000', 'selectedTodos'
        ));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoGP.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $pago->sede = 'GRUPO P, C.A';

            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoGP')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoGP')->first();
            ...
            return redirect('/efectivoGP')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.efectivoGP.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.efectivoGP.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosGP')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoGP.diferidos', compact('diferidos'));
    }
}
