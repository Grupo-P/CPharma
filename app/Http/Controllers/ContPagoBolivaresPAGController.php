...
use compras\ContPagoBolivaresPAG as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoBolivaresPAGController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresPAG.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresPAG.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoBolivaresPAG')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoBolivaresPAG')->first();
            ...
            return redirect('/bolivaresPAG')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.bolivaresPAG.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.bolivaresPAG.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosBolivaresPAG')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresPAG.diferidos', compact('diferidos'));
    }
}
