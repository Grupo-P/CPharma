...
use compras\ContPagoBolivaresCDD as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoBolivaresCDDController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresCDD.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresCDD.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoBolivaresCDD')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoBolivaresCDD')->first();
            ...
            return redirect('/bolivaresCDD')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.bolivaresCDD.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.bolivaresCDD.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosBolivaresCDD')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresCDD.diferidos', compact('diferidos'));
    }
}
