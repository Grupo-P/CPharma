...
use compras\ContPagoBolivaresFLL as ContPagoEfectivo;
...
class ContPagoBolivaresFLLController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresFLL.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosBolivaresFLL')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
