...
use compras\ContPagoEfectivoPAG as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoEfectivoPAGController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoPAG.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoPAG.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoPAG')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoPAG')->first();
            ...
            return redirect('/efectivoPAG')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.efectivoPAG.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.efectivoPAG.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosPAG')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoPAG.diferidos', compact('diferidos'));
    }
}
