            ...
            if (session('articulos')) {
                ...
                foreach ($cobeca as $item) {
                    if ($item['existencia'] > 0) {
                        ...
                        $costo_cobeca = (isset($_GET['descuentoCobeca']) && $_GET['descuentoCobeca'] != '') ? $costo_cobeca * $_GET['descuentoCobeca'] : $costo_cobeca;
                ...
                foreach ($lines as $field) {
                    if (in_array(trim(substr($field, 130, 17)), array_column($articulos, 'codigo_barra'))) {
                        if (trim(substr($field, 64, 12))) {
                            ...
                            $costo_nena = (isset($_GET['descuentoNena']) && $_GET['descuentoNena'] != '') ? $costo_nena * $_GET['descuentoNena'] : $costo_nena;
                ...
                foreach ($oeste as $item) {
                    if (in_array($item['A'], array_column($articulos, 'codigo_barra'))) {
                        ...
                        $precio_oeste = (isset($_GET['descuentoOeste']) && $_GET['descuentoOeste'] != '') ? $precio_oeste * $_GET['descuentoOeste'] : $precio_oeste;
                ...
                if ($drocerca[1]['A'] != null) {
                    foreach ($drocerca as $item) {
                        ...
                        if (in_array($item['B'], array_column($articulos, 'codigo_barra'))) {
                            ...
                            $precio_drocerca = (isset($_GET['descuentoDrocerca']) && $_GET['descuentoDrocerca'] != '') ? $precio_drocerca * $_GET['descuentoDrocerca'] : $precio_drocerca;
