...
class ContPagoEfectivoFAUController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFAU.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoFAU')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoFAU')->first();
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.efectivoFAU.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.efectivoFAU.edit', compact('pago'));
    }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFAU.diferidos', compact('diferidos'));
    }
}
