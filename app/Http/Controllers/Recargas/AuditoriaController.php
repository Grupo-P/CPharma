...
class AuditoriaController extends Controller
{
    ...
    public function cajasTransaccionales(Request $request){
        include app_path() . '/functions/config.php';
        include app_path() . '/functions/functions.php';
        ...
        if($request->sede!=null){
            ...
            switch($sede)
            {
                case 'DBs':
                    if(FG_Validar_Conectividad('FAU')==1){
                        $vueltos =  AuditoriaFau::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('fauRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;
                    }
                    else{
                        $vueltos=null;
                ...
                case 'FTN':
                    if(FG_Validar_Conectividad('FTN')==1){
                        $vueltos =  AuditoriaFtn::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('ftnRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;
                    }
                    else{
                        $vueltos=null;
                ...
                case 'FLL':
                    if(FG_Validar_Conectividad('FLL')==1){
                        $vueltos =  AuditoriaFll::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('fllRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;
                    }
                    else{
                        $vueltos=null;
                ...
                case 'FSM':
                    if(FG_Validar_Conectividad('FSM')==1){
                        $vueltos =  AuditoriaFsm::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('fmRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;
                    }
                    else{
                        $vueltos=null;
                ...
                case 'KDI':
                    if(FG_Validar_Conectividad('KDI')==1){
                        $vueltos =  AuditoriaKdi::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('kdiRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;
                    }
                    else{
                        $vueltos=null;
                ...
                case 'FEC':                    
                    if(FG_Validar_Conectividad('FEC')==1){
                        $vueltos =  AuditoriaFec::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('fecRecargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;                       
                    }
                    else{
                        $vueltos=[];
                ...
                case 'KD73':
                    if(FG_Validar_Conectividad('KD73')==1){
                        $vueltos =  AuditoriaKd73::whereBetween('fecha',[ $fini,$ffin])->select("black_boxes.*",DB::connection('kd73Recargas')->raw('SUM(black_boxes.monto) as totalMonto'))->groupBy('id_caja')->get();
                        $mensaje=null;                        
                    }
                    else{
                        $vueltos=[];
        ...
        return view('pages.recargas.cajas', compact('mensaje','vueltos','fini','ffin','sedeUsuario','sede'));   
    }
