...
use compras\ContPagoBolivaresGP as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoBolivaresGPController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresGP.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresGP.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoBolivaresGP')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoBolivaresGP')->first();
            ...
            return redirect('/bolivaresGP')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.bolivaresGP.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.bolivaresGP.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosBolivaresGP')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresGP.diferidos', compact('diferidos'));
    }
}
