...
use compras\ContPagoEfectivoFTN as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoEfectivoFTNController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFTN.index', compact(
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFTN.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoFTN')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoFTN')->first();
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.efectivoFTN.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.efectivoFTN.edit', compact('pago'));
    }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFTN.diferidos', compact('diferidos'));
    }
}
