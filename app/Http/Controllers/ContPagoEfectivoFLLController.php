...
class ContPagoEfectivoFLLController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoEfectivoFLL')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoEfectivoFLL')->first();
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.efectivoFLL.diferidos', compact('diferidos'));
    }
}
