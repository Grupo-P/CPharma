...
use compras\ContPagoBolivaresFEC as ContPagoEfectivo;
use compras\ContPrepagado;
use compras\ContProveedor;
use compras\Sede;
use Illuminate\Http\Request;

class ContPagoBolivaresFECController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresFEC.index', compact('pagos', 'sedes', 'request'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresFEC.create', compact('cuentas', 'request', 'prepagado', 'proveedores'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $configuracion  = Configuracion::where('variable', 'SaldoBolivaresFEC')->first();
            $configuracion2 = Configuracion::where('variable', 'DiferidoBolivaresFEC')->first();
            ...
            return redirect('/bolivaresFEC')->with('Saved', ' Informacion');
    ...
    public function soporte($id)
    {
        ...
        return view('pages.contabilidad.bolivaresFEC.soporte', compact('pago'));
    }
    ...
    {
        $pago = ContPagoEfectivo::find($id);
        return view('pages.contabilidad.bolivaresFEC.edit', compact('pago'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect('/contabilidad/diferidosBolivaresFEC')->with('Updated', ' Informacion');
        } catch (\Illuminate\Database\QueryException $e) {
            dd($e);
            return back()->with('Error', ' Error');
        }
    ...
    public function diferidos(Request $request)
    {
        ...
        return view('pages.contabilidad.bolivaresFEC.diferidos', compact('diferidos'));
    }
}
